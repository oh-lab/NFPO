...
def is_correct_strict_box(
    ...
    Returns:
        Tuple of (score, extracted_prediction), where score is 1 for correct and 0 for incorrect.
    """
...
def verify(
    ...
    if correct or pred != "[INVALID]":
        return correct, pred

    boxed_pred = last_boxed_only_string(solution_str)
    if boxed_pred is not None:
        pred = remove_boxed(boxed_pred)
        return normalize_final_answer(pred) == normalize_final_answer(answer), pred
