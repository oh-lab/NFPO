...
class MegatronPPOActor(BasePPOActor):
    ...
    def make_minibatch_iterator(self, data: DataProto) -> Iterable[DataProto]:
        ...
        # Include rollout_log_probs for NFPO forward-trace loss and rollout diagnostics.
    ...
    def forward_backward_batch(
        ...
        def loss_func(output, data, meta_info):
            ...
            if not forward_only:
                ...
                loss_mode = self.config.policy_loss.get("loss_mode", "nfpo")
                ...
                if loss_mode in {"nfpo", "forward_trace"}:
                    loss_kwargs["rollout_log_prob"] = data.get("rollout_log_probs", None)
